...
$string['settingsPageTOCDownLink']		= '<font style="color:red; font-weight:bold;" > DON\'T FORGET to click the Save button!</font>';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'headerlogopre'] 		= '<h4>LEFT header logo</h4>URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'headerlogoprealt'] 		= 'Alternative text:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'headerlogopost'] 		= '<h4>RIGHT header logo</h4>URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'headerlogopostalt'] 	= 'Alternative text:';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'headerbackground' . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_TARGET_SUFFIX] = 'Image formatting:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'headerbackground' . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_URL_SUFFIX] = '<h4>Middle - HEADER background image</h4>Link to image<br />URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'footerlogopre'] 		= '<h4>LEFT footer graphic</h4>URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'footerlogoprealt'] 		= 'Alternative text';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'footerlogopost'] 		= '<h4>RIGHT footer graphic</h4>URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'footerlogopostalt'] 	= 'Alternative text';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'colour_examples']		= '<h4>Colour palette tonal value</h4><p>Select what tonal value you would like you colour scheme to be.</p>';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'palette_examples' ]		= '<h4>Colour scheme</h4><p>Select COLOUR OPTION 1 and COLOUR OPTION 2 or leave as default.</p>';

$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_off_dt'] 			= 'Background colour options:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_off_he'] 			= 'Background colour options:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_off_tb'] 			= 'Background colour options:';	
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_off_mm'] 			= 'Background colour options:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_off_fo'] 			= 'Background colour options:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_pal_dt'] 			= '<h4>DESKTOP</h4>Text and background combination:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_pal_he'] 			= '<h4>HEADER</h4>Text and background combination:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_pal_tb'] 			= '<h4>TOOLBAR</h4>Text and background combination:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_pal_mm'] 			= '<h4>MAIN CONTENT</h4>Text and background combination:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'clr_pal_fo'] 			= '<h4>FOOTER</h4>Text and background combination:';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'gradient_covers'] 		= '<h4>Gradient effects</h4>Adds a shade that fades to transparent (either light or dark) to background. Gradients can be applied on top of background colour, pattern or image.';

$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metaheader1'  . IcandConstantsBackend::SETTINGS_IMG_SUFFIX] = '<h4>Upper - </font>HEADER background image</h4>Link to image<br /> URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metaheader1'  . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metafooter'   . IcandConstantsBackend::SETTINGS_IMG_SUFFIX] = '<h4>FOOTER background image</h4>Link to image<br /> URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metafooter'	  . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metatoolbar1' . IcandConstantsBackend::SETTINGS_IMG_SUFFIX] = '<h4>Upper - TOOLBAR background image</h4>Link to image<br /> URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metatoolbar1' . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';	
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metatoolbar2' . IcandConstantsBackend::SETTINGS_IMG_SUFFIX] = '<h4>Lower - TOOLBAR background image</h4>Link to image<br /> URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metatoolbar2' . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';		
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'coursepage'   . IcandConstantsBackend::SETTINGS_IMG_SUFFIX] = '<h4>MAIN CONTENT background image</h4>Link to image<br />URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'coursepage'   . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';

$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metadesktop'  . IcandConstantsBackend::SETTINGS_IMG_SUFFIX] = '<h4>Desktop - FRONT layer</h4>Link to image<br />URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'metadesktop'  . IcandConstantsBackend::SETTINGS_IMG_SUFFIX . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';	// NB IcandConstantsBackend::SETTINGS_STYLE_SUFFIX

$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_DESKTOP_TILE_GRAPHIC ] = '<h4>Desktop - BACK layer</h4>Built-in tiled graphic background:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_DESKTOP_TILE_GRAPHIC . IcandConstantsBackend::SETTINGS_URL_SUFFIX] = 'Link to image<br />URL:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_DESKTOP_TILE_GRAPHIC . IcandConstantsBackend::SETTINGS_STYLE_SUFFIX] = 'Image formatting:';

$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_DECORATION_COURSE_TARGET] 	= '<h4>Content section (weeks/topics) background styling</h4>Separate course sections';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'table_spacing'] 			= '<h4>Column spacing and margins</h4>Spacing between columns in main content area';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_DECORATION_SIDEBAR_TARGET ] 		= '<h4>Blocks and column styling</h4>Block style'; // 
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'layout_make_borders'] 		= '<h4>Borders</h4>Blocks and section borders';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_MENU_SITENAVPLACEMENT ] = '<h4>NAVIGATON TOOLS</h4> Set location:';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'menu_userplacement'] 		= '<h4>ACCESSIBILITY AND ADMIN TOOLS</h4> Set location:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'menu_pageidplacement'] 		= '<h4>SITE AND COURSE TITLES</h4>Set location:';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . 'foottxtpre'] 				= '<h4>CUSTOM FOOTER</h4><p style="font-weight:normal;">Add plain text or HTML to these field to add custom content to your footer<br />NOTE: this text will display across the whole site.</p>LEFT:';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_MASTER] = '<h4>Master</h4>Course-level overrides';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_PREFIX . 'general'] 			= '<h4>General permissions</h4>';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_PREFIX . 'menu'] 				= '<h4>Utilities - navigation, login, accessibility, footer text and titles</h4>';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_PREFIX . 'header'] 			= '<h4>Logos</h4>Header logos';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_PREFIX . 'footer'] 			= 'Footer logos';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_PREFIX . 'layout'] 			= '<h4>Layout and images</h4>Content area width';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_TITLES . IcandConstantsBackend::DB_FIELD_PERMIT_PREFIX . 'colour'] 			= '<h4>Colour settings</h4>';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_DESCRIPTIONS . 'colour'] 				= '<h4>Applying colours:</h4><p>NOTE: that the ability to change offset colour at course level will determined by the administrator and the permissions made available.</p><ol><li>Select the theme <strong>colour palette tonal value</strong> if required</li><li>Define <strong>COLOUR OPTION 1.</strong> Default value=8 (blue)</li><li>Define <strong>COLOUR OPTION 2.</strong> Default value=8 (blue)</li><li>In each region, select text colour and background colour combination (light text on dark background / dark text on light background)</li></ol>';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_DESCRIPTIONS . 'colour_base'] 		= '';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_DESCRIPTIONS . 'colour_base_supp'] 	= 'If you require a different colour for a specific region such as the header then under the header colour section select a colour offset number.<p>For example, instead of light blue in the header pink is preferred.</p><ul><li>If COLOUR OPTION 1 is defined as 8 (blue)</li><li>Under <i><strong>Header</strong></i> > <i><strong>Text and background combination</strong></i> select <strong>COLOUR OPTION 1: dark text on light background</strong>, this makes the background a light shade.</li><li>Then, under <i><strong>Header</strong></i> > <i><strong>Background colour options</strong></i> select +4 which offsets the original colour to a shade of red/pink.</li></ul><p>NOTE: If using transparent the text colour will reflect the next layer which has a background applied.</p>';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_DESCRIPTIONS . 'colour_palettes'] 	= 'textext';
...
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_XY_OPTIONS . IcandConstantsBackend::makeIdSafeForGetString('base~light')]		= 'COLOUR OPTION 1:<br />Dark text on light background';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_XY_OPTIONS . IcandConstantsBackend::makeIdSafeForGetString('base~dark')]		= 'COLOUR OPTION 1:<br />Light text on dark background';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_XY_OPTIONS . IcandConstantsBackend::makeIdSafeForGetString('base_supp~light')]	= 'COLOUR OPTION 2:<br />Dark text on light background';
$string[IcandConstantsBackend::DISPLAY_PREFIX_FOR_XY_OPTIONS . IcandConstantsBackend::makeIdSafeForGetString('base_supp~dark')]	= 'COLOUR OPTION 2:<br />Light text on dark background';
...
$string[ IcandConstantsBackend::DISPLAY_PREFIX_FOR_MONO_OPTIONS . 'light'] 		= '<br />light-primary';	// the CSS files are /style/palette_*.css	
$string[ IcandConstantsBackend::DISPLAY_PREFIX_FOR_MONO_OPTIONS . 'saturated'] 	= '<br />saturated-primary';
$string[ IcandConstantsBackend::DISPLAY_PREFIX_FOR_MONO_OPTIONS . 'dark' ] 		= '<br />dark-primary';
